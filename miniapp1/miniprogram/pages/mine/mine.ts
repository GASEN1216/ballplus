...
Page({
    ...
    loadDisplaySettings() {
        ...
        this.setData({
            showActivityCountdown: showActivityCountdown !== false, // 默认为true
            showActivityManagement: showActivityManagement !== false,
            showFriendManagement: showFriendManagement !== false,
            showForumManagement: showForumManagement !== false
        });
    },
    ...
    goToEditInfo() {
        wx.navigateTo({
            url: '/profilePackage/pages/editProfile/editProfile', // 跳转到编辑信息页面
        });
    },
    ...
    goToInfo() {
        wx.navigateTo({
            url: `/profilePackage/pages/profile/profile?userId=${this.data.userData.id}`,
        });
    },
    ...
    navigateToSettings() {
        wx.navigateTo({
            url: '/profilePackage/pages/settings/settings'
        });
    },
    ...
    goToMyPosts() {
        ...
        wx.navigateTo({
            url: '/forumPackage/pages/myPosts/myPosts'
        });
    },
    ...
    goToMyComments() {
        ...
        wx.navigateTo({
            url: '/forumPackage/pages/myComments/myComments'
        });
    },
    ...
    viewFriendRequests() {
        ...
        wx.navigateTo({
            url: '/profilePackage/pages/friendRequests/friendRequests?type=0',
        });
    },
    ...
    onShareAppMessage() {
        const currentUser = app.globalData.currentUser;
        return {
            title: `${currentUser.name || '我'}的个人主页 - 一起来玩球吧！`,
